...
corpus = Corpus('E:\pythonProject\ML_LHY\神雕侠侣.txt')
...
for sim_word in word_vec.most_similar(positive=['郭襄'], topn=10):
    print(sim_word)


tsne_scatter_plot(model, '小龙女')